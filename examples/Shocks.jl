...
## WITHOUT DITCHES ##
abuns = runFuture();
@save "/home/claireh/sdc/Peatland/Peatland_future_shock.jld2" abuns=abuns[:, :, [12,end]]
...
Plots.pdf("Abuns_future_shock.pdf")
...
abuns = runPast();
@save "/home/claireh/sdc/Peatland/Peatland_past_shock.jld2" abuns=abuns[:, :, [12,end]]
...
plot!(0:3/12:70, mean(sum(abuns[trees, :, :], dims = 2)[:, 1, :], dims = 1)[1, :], grid = false, label = "", subplot = 3,
   colour = :black)
vline!([60], subplot = 3, color = :black, lty = :dot, label = "")
Plots.pdf("Abuns_past_shock.pdf")
