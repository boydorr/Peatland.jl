...
burnin = 1year; times = 1year; timestep = 1day; record_interval = 1day; repeats = 1
lensim = length(0years:record_interval:times)
abuns1 = generate_storage(eco, lensim, 1)
abuns2 = generate_storage(eco, lensim, 1)
# Burnin
@time simulate!(eco, burnin, timestep)
scenario = SimpleScenario(Invasive, 1.0/7days)
@time simulate_record!(abuns1, eco, times, record_interval, timestep, scenario)
eco.abenv.habitat.change.rate = -10.0m^3/day
eco.abundances.matrix[2, :] .= 1
@time simulate_record!(abuns2, eco, times, record_interval, timestep, scenario)
